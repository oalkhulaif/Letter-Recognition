Letter Recognition from Images
📌 Project Overview
This project focuses on recognizing black-and-white pixelated uppercase English letters using machine learning models. The dataset consists of 17,338 samples generated from 20 different fonts, with random distortions to simulate real-world variability. The project was developed as part of COE 292: Introduction to Artificial Intelligence at King Fahd University of Petroleum and Minerals (KFUPM).
